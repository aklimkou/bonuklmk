...
export function AboutMe() {
  return (
    <section className="pt-24 pb-12 px-4 md:px-6 bg-[#e8dcc4]">
      <div className="max-w-5xl mx-auto">
        {/* Header */}
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-light tracking-[0.2em] mb-3">
            STYLIST
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center max-w-4xl mx-auto">
          ...
          <div className="space-y-5">
            <h2 className="text-2xl md:text-3xl font-light tracking-wide leading-tight">
              HI! MY NAME IS BONU
            </h2>
