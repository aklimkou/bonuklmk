  ...
  return (
    <section id="services" className="py-20 bg-white">
      <div className="max-w-[1000px] mx-auto px-5">
        <h2 className="text-center text-[1.75rem] md:text-[2rem] font-light tracking-wide mb-8 md:mb-[50px]">
          Services
        </h2>
        <div className="max-w-[800px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
